...
#define STORE_SASA_VAL(skip_pc, reg1, reg2, condition, insts_to_skip, tempreg1, tempreg2) \
la tempreg1, skip_pc; \
slli tempreg1, tempreg1, 16; \
lui  tempreg2, CALC_SASA_VAL(reg1, reg2, condition, insts_to_skip); \
srli tempreg2, tempreg2, 12; \
or   tempreg1, tempreg1, tempreg2;\
sw   tempreg1,;

#define STORE_SASA_FROM_MEM(mem_label, tempreg1, tempreg2) \
